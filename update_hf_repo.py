...
required_files = [
    ...
    ("eval_results/qwen35_2b_multistep_n200_eval.json", "eval_results/qwen35_2b_multistep_n200_eval.json"),
    ("eval_results/README.md", "eval_results/README.md"),
    ("eval_results/archive_deprecated/README.md", "eval_results/archive_deprecated/README.md"),
